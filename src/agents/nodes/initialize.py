...
async def initialize_node(llm, date, progress_callback, state: AgentState):
    console.print(Panel(f"[bold blue]Starting Research:[/] {state['query']}", title="Research Progress", border_style="blue"))
